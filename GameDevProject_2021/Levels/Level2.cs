    ...
    class Level2 : ILevel
    {
        ...
        private void InitializeGameObject()
        {
            ...
            GameObjects = new List<GameObject>()
            {
                ...
                GameObjectFactory.CreateGameObject("FireWall", Game1.ScreenWidth/3, Game1.ScreenHeight, walltexture),
                GameObjectFactory.CreateGameObject("FireWall", Game1.ScreenWidth-400, Game1.ScreenHeight, walltexture),
                GameObjectFactory.CreateGameObject("FireWall", 0, Game1.ScreenHeight+walltexture.Height-50, walltexture),
                GameObjectFactory.CreateGameObject("FireWall", Game1.ScreenWidth/3, Game1.ScreenHeight+walltexture.Height-50, walltexture),
                GameObjectFactory.CreateGameObject("FireWall", Game1.ScreenWidth-400, Game1.ScreenHeight+walltexture.Height-50, walltexture),
